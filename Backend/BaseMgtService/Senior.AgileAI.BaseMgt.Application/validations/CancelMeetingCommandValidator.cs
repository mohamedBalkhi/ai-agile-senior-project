...
public class CancelMeetingCommandValidator : AbstractValidator<CancelMeetingCommand>
{
    ...
    public CancelMeetingCommandValidator(IUnitOfWork unitOfWork)
    {
        ...
        RuleFor(x => x.MeetingId)
            ...
            .DependentRules(() => {
                ...
                }).WithMessage("Only scheduled meetings can be cancelled");
                ...
                }).WithMessage("You don't have permission to cancel this meeting");
            });
