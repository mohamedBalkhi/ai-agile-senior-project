...
namespace Senior.AgileAI.BaseMgt.Api.Migrations
{
    ...
    [Migration("20250121003251_OnlineMeetingFields")]
    partial class OnlineMeetingFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Senior.AgileAI.BaseMgt.Domain.Entities.CalendarSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("CalendarSubscriptions", "public");
                });
            ...
            modelBuilder.Entity("Senior.AgileAI.BaseMgt.Domain.Entities.Meeting", b =>
                {
                    ...
                    b.Property<string>("AIProcessingToken")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<DateTime?>("OnlineMeetingEndedAt")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("OnlineMeetingStartedAt")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int>("OnlineMeetingStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<Guid?>("OriginalMeeting_IdMeeting")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OriginalMeeting_IdMeeting");
            ...
            modelBuilder.Entity("Senior.AgileAI.BaseMgt.Domain.Entities.Meeting", b =>
                {
                    ...
                    b.HasOne("Senior.AgileAI.BaseMgt.Domain.Entities.Meeting", "OriginalMeeting")
                        .WithMany("RecurringInstances")
                        .HasForeignKey("OriginalMeeting_IdMeeting")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.OwnsOne("Senior.AgileAI.BaseMgt.Domain.ValueObjects.MeetingAIReport", "AIReport", b1 =>
                        {
                            b1.Property<Guid>("MeetingId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");

                            b1.Property<List<string>>("KeyPoints")
                                .HasColumnType("jsonb")
                                .HasColumnName("AIKeyPoints");

                            b1.Property<string>("MainLanguage")
                                .IsRequired()
                                .HasMaxLength(20)
                            ...
                            b1.Property<string>("Transcript")
                                .HasColumnType("text")
                                .HasColumnName("AITranscript");

                            b1.HasKey("MeetingId");

                            b1.ToTable("Meetings", "public");
