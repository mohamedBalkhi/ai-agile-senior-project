...
class DecodedToken {
  ...
  factory DecodedToken.fromJwt(String token) {
    ...
    return DecodedToken(
      ...
      isAdmin: (payload[isAdminClaim]?.toString().toLowerCase() == 'true'),
      isTrusted: (payload[isTrustedClaim]?.toString().toLowerCase() == 'true'),
      isActive: (payload[isActiveClaim]?.toString().toLowerCase() == 'true'),
